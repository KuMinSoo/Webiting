		...
		<form id="dtf" name="dtf" action="orderedCancel" method="get">			
			<div>
				...
				<div class="form-check form-check-inline" style="margin:10px 30px 10px;">
		  			<input class="form-check-input" type="radio" name="orderStatusMode" id="orderStatusMode2" value="1"
					   <c:if test="${paging.orderStatusMode=='3'}"> checked </c:if>>
		  			<label class="form-check-label" for="orderStatusMode">전체</label>
				</div>
				<div class="form-check form-check-inline" style="margin:10px 30px 10px;">
		  			<input class="form-check-input" type="radio" name="orderStatusMode" id="orderStatusMode2" value="1"
					   <c:if test="${paging.orderStatusMode=='1'}"> checked </c:if>>
		  			<label class="form-check-label" for="orderStatusMode">취소/환불대기</label>
				</div>
				<div class="form-check form-check-inline" style="margin:10px 30px 10px;">
		  			<input class="form-check-input" type="radio" name="orderStatusMode" id="orderStatusMode3" value="2"
