...
<div style="position:fixed;display:inline-block;width:9%;margin-top:3%;margin-left:2%;margin-right:5%;">
          <div class="card">
              <!--card-header : 카드 제목 부분 설정-->
              <div class="card-header">상품 및 매출</div> 
              <!--list-group : 수직 목록 생성-->
              <!--list-group-flush : 카드 영역에 목록 생성--> 
              <div class="list-group list-group-flush"> 
                  <a href="${myctx}/admin/prodForm" class="list-group-item list-group-item-action">상품등록</a>
                  <a href="${myctx}/admin/chart" class="list-group-item list-group-item-action">매출통계</a>
              </div>
          </div>
          <br>
